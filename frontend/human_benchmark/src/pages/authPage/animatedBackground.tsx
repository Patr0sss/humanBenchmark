...
const App: React.FC = () => {
  ...
  return (
    <>
        <div className='fixed top-0 bottom-0 left-0 right-0 mask'>
            {/* Background mask */}
        </div>
        <div className='relative flex items-center justify-center min-h-screen'>
            <div className='bg-[#201d22] rounded-xl max-w-[1200px] w-full h-[50%] my-6 px-4 flex items-center'>
                <div className='w-full '>
                    <div className="row-span-1 py-8 text-left text-white">
                    ...
                    <motion.button 
                        ...
                        className="w-full bg-gradient-to-br from-[#4a47d7] to-[#7632cc] p-4 font-medium text-2xl text-white rounded-xl">Login</motion.button>
                    </div>
                </div>
            </div>
        </div>
