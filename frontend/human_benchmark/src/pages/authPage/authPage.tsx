        ...
        <div className="relative p-4 m-4 rounded-lg md:grid-rows-5 md:grid">
          ...
          <div className=" w-full grid row-span-2  border-b-[1px]  border-[#383439] mb-12">
            ...
            <div className="row-span-1 text-left text-white ">
              ...
              <h1 className="text-2xl xl:text-2xl md:text-xl">Enter your credentials to access your account</h1>
            </div>
            ...
            <div className="outline outline-1 outline-[#383439] flex rounded-2xl items-center justify-center cursor-pointer hover:scale-110 hover:ease-in-out hover:duration-300 transform transition my-4 md:my-0">
                ...
                <h1 className="my-4 text-lg font-bold xs:p-4 sm:my-0 xl:text-lg md:text-sm whitespace-nowrap">Log in with Google</h1>
              </div>
              <div className="outline outline-1 outline-[#383439] flex rounded-2xl items-center justify-center cursor-pointer hover:scale-110 hover:ease-in-out hover:duration-300 transform transition my-4 md:my-0">
          ...
          <div className="row-span-3 -mt-8">
            ...
            <div className="flex justify-center">
              <span className="flex text-xl text-white">Already a member? &#8203;
                <Link to="/login">
                  <h1 className=" text-[#7632cc] text-xl cursor-pointer hover:border-b-2 hover:border-[#7632cc] hover:font-bold">Login</h1>
                </Link>
              </span>
            </div>
          </div>
